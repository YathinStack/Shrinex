  ...
  useEffect(() => {
    ...
    function render() {
      ...
      if (pointer.moved) {
        ...
        gl.uniform1i(
          splatProgram.uniforms.u_input_txr as WebGLUniformLocation,
          velocity.read().attach(0)
        );
        gl.uniform1f(
          splatProgram.uniforms.u_ratio as WebGLUniformLocation,
          canvas!.width / canvas!.height
        );
        gl.uniform2f(
          splatProgram.uniforms.u_point as WebGLUniformLocation,
          pointer.x / canvas!.width,
          1 - pointer.y / canvas!.height
        );
        gl.uniform3f(
          splatProgram.uniforms.u_point_value as WebGLUniformLocation,
          pointer.dx,
          -pointer.dy,
          1
        );
        gl.uniform1f(splatProgram.uniforms.u_point_size as WebGLUniformLocation, params.SPLAT_RADIUS);
      ...
      gl.uniform2f(
        divergenceProgram.uniforms.u_vertex_texel as WebGLUniformLocation,
        velocity.texelSizeX,
        velocity.texelSizeY
      );
      gl.uniform1i(
        divergenceProgram.uniforms.u_velocity_txr as WebGLUniformLocation,
        velocity.read().attach(0)
      );
      blit(divergence);
      ...
      gl.uniform2f(
        pressureProgram.uniforms.u_vertex_texel as WebGLUniformLocation,
        velocity.texelSizeX,
        velocity.texelSizeY
      );
      gl.uniform1i(
        pressureProgram.uniforms.u_divergence_txr as WebGLUniformLocation,
        divergence.attach(0)
      );
      for (let i = 0; i < params.PRESSURE_ITERATIONS; i++) {
        gl.uniform1i(
          pressureProgram.uniforms.u_pressure_txr as WebGLUniformLocation,
      ...
      gl.uniform2f(
        gradientSubtractProgram.uniforms.u_vertex_texel as WebGLUniformLocation,
        velocity.texelSizeX,
        velocity.texelSizeY
      );
      gl.uniform1i(
        gradientSubtractProgram.uniforms.u_pressure_txr as WebGLUniformLocation,
        pressure.read().attach(0)
      );
      gl.uniform1i(
        gradientSubtractProgram.uniforms.u_velocity_txr as WebGLUniformLocation,
      ...
      gl.uniform2f(
        advectionProgram.uniforms.u_vertex_texel as WebGLUniformLocation,
        velocity.texelSizeX,
        velocity.texelSizeY
      );
      gl.uniform2f(
        advectionProgram.uniforms.u_output_textel as WebGLUniformLocation,
        velocity.texelSizeX,
        velocity.texelSizeY
      );

      gl.uniform1i(
        advectionProgram.uniforms.u_velocity_txr as WebGLUniformLocation,
        velocity.read().attach(0)
      );
      gl.uniform1i(
        advectionProgram.uniforms.u_input_txr as WebGLUniformLocation,
        velocity.read().attach(0)
      );
      gl.uniform1f(advectionProgram.uniforms.u_dt as WebGLUniformLocation, dt);
      gl.uniform1f(
        advectionProgram.uniforms.u_dissipation as WebGLUniformLocation,
      ...
      gl.uniform1i(
        displayProgram.uniforms.u_output_texture as WebGLUniformLocation,
        outputColor.read().attach(0)
      );
      blit();
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-black text-white">
      ...
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[90%] md:max-w-[50%] pointer-events-none z-10 text-center mix-blend-difference">
        <h1
          className="uppercase tracking-tight leading-none mix-blend-difference"
          style={{
